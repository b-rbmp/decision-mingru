...
# class DecisionMinGRU(TrajectoryModel):
#     """
#     This model uses MinGRU
#     """
#     def __init__(
#             self,
#             state_dim,
...
#         self.transformer = GPT2Model(config)
#         self.rnn_network = MinRNNNetwork(
#             vocab_size=config.vocab_size, embedding_dim=hidden_size, num_layers=3, expansion_factor=2, dropout=0.1, rnn_architecture="minGRU"
#         )
#         self.remove_act_embs = remove_act_embs
