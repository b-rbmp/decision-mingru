...
class MinRNNNetwork(nn.Module):
    ...
    Args:
        input_dim: Number of embeddings
    ...
    """
    def __init__(
        self, input_dim: int, embedding_dim=64, num_layers=3, expansion_factor=2, dropout=0.1, rnn_architecture="minGRU"
    ):
        ...
        # Define embedding layer for input tokens (input_dim -> embedding_dim)
        # self.embedding = nn.Embedding(
        #     num_embeddings=self.input_dim, embedding_dim=embedding_dim, padding_idx=0
        # )
